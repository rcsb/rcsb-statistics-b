...
export function FacetPlot(props: FacetPlotInterface) {
    ...
    const getSelectedDataText = (): string => {
        if (selectedDataSets.size === 2) {
            return "Cumulative (available each year) and annual number of released small molecules";
        } else if (selectedDataSets.has("Cumulative")) {
            return "Cumulative (available each year) number of released small molecules";
        } else if (selectedDataSets.has("Annual")) {
            return "Annual number of released small molecules";
        } else {
