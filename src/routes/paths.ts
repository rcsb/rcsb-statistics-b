const paths = {
  ...
  PDB_DATA_GROWTH_BY_DOMAINS: '/growth/number-of-domains',
  PDB_DATA_GROWTH_BY_UNIQUE: '/growth/unique-protein-sequences',
  PDB_DATA_DISTRIBUTION: '/pdb-data-distribution',
