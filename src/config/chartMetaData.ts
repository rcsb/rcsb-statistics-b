...
export const statisticsList = [
  { text: 'Growth by Overall Structures', link: paths.PDB_DATA_GROWTH('overall-structures') },
  { text: 'Growth by Overall Small Molecules', link: paths.PDB_DATA_GROWTH('overall-small-molecules') },
  { text: 'Growth by Experimental Method', link: paths.PDB_DATA_GROWTH('experimental-method') },
  { text: 'Growth by Molecular Composition', link: paths.PDB_DATA_GROWTH('molecular-composition') },
  { text: 'Growth by Assembly Symmetry', link: paths.PDB_DATA_GROWTH('assembly-symmetry') },
  { text: 'Growth by Number of Domains', link: paths.PDB_DATA_GROWTH('number-of-domains') },
  { text: 'Growth by Unique Protein Sequences', link: paths.PDB_DATA_GROWTH('unique-protein-sequences') },
  { text: 'Distribution by Resolution', link: paths.PDB_DATA_DISTRIBUTION('distribution-resolution') },
  { text: 'Distribution by R-free', link: paths.PDB_DATA_DISTRIBUTION('distribution-r-free') },
  { text: 'Distribution by Molecular Weight (Structure)', link: paths.PDB_DATA_DISTRIBUTION('distribution-molecular-weight-structure') },
  { text: 'Distribution by Atom Count', link: paths.PDB_DATA_DISTRIBUTION('distribution-atom-count') },
  { text: 'Distribution by Residue Count', link: paths.PDB_DATA_DISTRIBUTION('distribution-residue-count') },
  { text: 'Distribution by Source Organism', link: paths.PDB_DATA_DISTRIBUTION('distribution-source-organism-natural') },
  { text: 'Distribution by Taxonomy', link: paths.PDB_DATA_DISTRIBUTION('taxonomy') },
  { text: 'Distribution by Processing Software', link: paths.PDB_DATA_DISTRIBUTION('distribution-software') },
  { text: 'Distribution by Space Groups', link: paths.PDB_DATA_DISTRIBUTION('distribution-space-group') },
  { text: 'Distribution by Publication Journal', link: paths.PDB_DATA_DISTRIBUTION('distribution-journal') },
  { text: 'Distribution by Structural Genomics Centers', link: paths.PDB_DATA_DISTRIBUTION('distribution-structural-genomics-centers') },
  { text: 'Distribution by Enzyme Classification', link: paths.PDB_DATA_DISTRIBUTION('enzyme-classification-name') },
  { text: 'Distribution by Assembly Symmetry', link: paths.PDB_DATA_DISTRIBUTION('assembly-symmetry-dist') },
  { text: 'Distribution by SCOP Classification', link: paths.PDB_DATA_DISTRIBUTION('scop-classification') },
]
